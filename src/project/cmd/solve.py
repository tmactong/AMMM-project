...
def run_main(data_file: str, algorithm: ALGORITHM, alpha: float = 0, local_search: bool = False, draw: bool = False) -> None:
    with Solver(data_file, algorithm, alpha, local_search, draw_graph=draw) as solver_instance:
